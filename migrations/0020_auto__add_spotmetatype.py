...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'spotseeker_server.spot': {
            ...
            'spotmetatypes': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'spots_set'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['spotseeker_server.SpotMetaType']"}),
