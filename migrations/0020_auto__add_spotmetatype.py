...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SpotMetaType'
        db.create_table('spotseeker_server_spotmetatype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal('spotseeker_server', ['SpotMetaType'])

        # Adding M2M table for field spotmetatypes on 'Spot'
        m2m_table_name = db.shorten_name('spotseeker_server_spot_spotmetatypes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('spot', models.ForeignKey(orm['spotseeker_server.spot'], null=False)),
            ('spotmetatype', models.ForeignKey(orm['spotseeker_server.spotmetatype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['spot_id', 'spotmetatype_id'])


    def backwards(self, orm):
        # Deleting model 'SpotMetaType'
        db.delete_table('spotseeker_server_spotmetatype')

        # Removing M2M table for field spotmetatypes on 'Spot'
        db.delete_table(db.shorten_name('spotseeker_server_spot_spotmetatypes'))
    ...
    models = {
        ...
        'spotseeker_server.spot': {
            ...
            'spotmetatypes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'spots_by_meta'", 'to': "orm['spotseeker_server.SpotMetaType']", 'max_length': '50', 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
        ...
        'spotseeker_server.spotmetatype': {
            'Meta': {'object_name': 'SpotMetaType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
